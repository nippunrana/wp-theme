 ...
 */
if ( ! function_exists( 'egnitech_one_get_installed_fonts' ) ) {
 ...
 */
if ( ! function_exists( 'egnitech_one_get_font_assignments' ) ) {
 ...
 */
if ( ! function_exists( 'egnitech_one_parse_font_preset' ) ) {
